    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <?php if ($role === '2'): ?>
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('report_user') ?>" class="nav-link <?php echo $uri == 'report_user' ? 'active' : 'no' ?>">
              <i class="fas fa-user nav-icon"></i>
              <p>Report</p>
            </a>
          </li>
        ...
        <?php if ($role === '3'): ?>
          ...
          <li class="nav-item has-treeview <?php echo $uri == 'laporan_transaksi' || $uri == 'laporan_stok_masuk' || $uri == 'laporan_stok_keluar' ? 'menu-open' : 'no' ?>">
            <a href="<?php echo site_url('laporan') ?>" class="nav-link <?php echo $uri == 'laporan_transaksi' || $uri == 'laporan_stok_masuk' || $uri == 'laporan_stok_keluar' ? 'active' : 'no' ?>">
              <i class="fas fa-book nav-icon"></i>
              <p>Laporan</p>
              <i class="right fas fa-angle-right"></i>
            </a>
            <ul class="nav-treeview">
              <li class="nav-item">
                <a href="<?php echo site_url('laporan_transaksi') ?>" class="nav-link <?php echo $uri == 'laporan_transaksi' ? 'active' : 'no' ?>">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('report') ?>" class="nav-link <?php echo $uri == 'report' ? 'active' : 'no' ?>">
              <i class="fas fa-user nav-icon"></i>
              <p>Report</p>
            </a>
          </li>
        ...
        <?php if ($role === '4'): ?>
          ...
          <li class="nav-item has-treeview <?php echo $uri == 'laporan_transaksi' || $uri == 'laporan_stok_masuk' || $uri == 'laporan_stok_keluar' ? 'menu-open' : 'no' ?>">
            ...
            <ul class="nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo site_url('laporan_report') ?>" class="nav-link <?php echo $uri == 'laporan_report' ? 'active' : 'no' ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Laporan Report</p>
                </a>
              </li>
